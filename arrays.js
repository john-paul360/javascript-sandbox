...
// METHOD TO ADD
// PUSH (add to the back), UNSHIFT (add to the front), add element to an array
...
// INCLUDES (to check if an element is inside an array)
...
// SOME AND EVERY
// SOME - (retruns true if at least one of every element passes a test)
...
// z-a
// SORTING NUMBER 0 - up, up - 0 (with numbers it has a COMPARE NUMBER)
